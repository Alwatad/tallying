...
// Seed data for initial Tallying setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Tallying store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Tallying. All rights reserved.',
  },
  settings: {
    siteName: 'Tallying',
